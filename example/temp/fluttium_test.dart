...
import '/Users/wolfen/Projects/personal/fluttium/example/lib/main.dart' as app;
...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.expectVisible('0');
      
      await tester.tapOn('Increment');
      
      await tester.expectVisible('1');
      
      await tester.tapOn('Increment');
      
      await tester.expectVisible('2');
      
      await tester.tapOn('Increment');
      
      await tester.expectNotVisible('4');
      
      await tester.tapOn('Increment');
      
      await tester.expectVisible('4');
      
      await tester.tapOn('Increment');
      
      await tester.expectVisible('5');
