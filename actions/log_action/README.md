...
<p align="center">
<a href="https://pub.dev/packages/log_action"><img src="https://img.shields.io/pub/v/log_action.svg" alt="Pub"></a>
...
A simple logging action for the [Fluttium](https://fluttium.dev) user flow testing framework.
